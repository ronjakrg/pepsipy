...
### PEPSI Package
> [!CAUTION]
> The release of the package on PyPI is still pending. See related [issue](https://github.com/pypi/support/issues/6869) for updates.
...
3. Install PEPSI <br>
   ```pip install pepsi```
4. Import and use PEPSI in your project! For more details, see section [How to use PEPSI](#how-to-use-pepsi).
